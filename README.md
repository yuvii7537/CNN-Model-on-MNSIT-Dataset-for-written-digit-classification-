I’m excited to share a key project from my internship experience — building a Convolutional Neural Network (CNN) model to classify handwritten digits from the widely used MNIST dataset.
